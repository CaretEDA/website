      ...
      <div class="max-w-[1000px] mx-auto">
        ...
        <div class="flex flex-col gap-6">
          <ng-container *ngFor="let item of news">
            ...
            <!-- Clickable card (external link) -->
            <a *ngIf="item.link; else staticCard"
               [href]="item.link" target="_blank" rel="noopener noreferrer"
               class="group block no-underline bg-[#0d1f3c] border border-[#2563EB]/50 rounded-2xl p-6 md:p-8 transition-all duration-300 hover:-translate-y-1 hover:bg-[#112244] hover:shadow-[0_10px_30px_rgba(37,99,235,0.15)] backdrop-blur-sm">
            ...
            <ng-template #staticCard>
              <article class="group bg-[#0d1f3c] border border-[#2563EB]/50 rounded-2xl p-6 md:p-8 transition-all duration-300 hover:-translate-y-1 hover:bg-[#112244] hover:shadow-[0_10px_30px_rgba(37,99,235,0.15)] backdrop-blur-sm">
                <p class="text-[#2563EB] text-xs uppercase tracking-widest font-semibold mb-3">{{ item.date }}</p>
