  ...
  template: `
    <section class="min-h-screen bg-black text-white pt-28 pb-20 px-4 md:px-8">
      <div class="w-full max-w-[900px] mx-auto">
        ...
        <!-- Back link -->
        <div class="mb-10">
          <a [routerLink]="['/careers']" class="inline-flex items-center gap-2 text-white/40 hover:text-[#2563EB] text-sm no-underline transition-colors">
            ← Back to Careers
          </a>
        </div>

        <!-- Job header card -->
        <div class="bg-[#0f1a30]/70 border border-[#2563EB]/25 rounded-2xl p-6 md:p-8 mb-6">
        ...
        <div class="bg-[#0f1a30]/70 border border-[#2563EB]/25 rounded-2xl p-6 md:p-8 mb-6">
          ...
          <div class="space-y-4 text-white/85 text-base leading-relaxed">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div class="bg-[#0f1a30]/70 border border-[#2563EB]/25 rounded-2xl p-6 md:p-8">
        ...
        <!-- Bottom CTA -->
        <div class="bg-[#0f1a30]/70 border border-[#2563EB]/25 rounded-2xl p-8 text-center">
